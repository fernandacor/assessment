...
# Función para hacer la inferencia al pasarle
# def infer_crop(input_vector, model, scaler, label_encoder):
#     model.eval()

#     # Asegurar formato correcto
#     input_array = np.array(input_vector).reshape(1, -1)  # (1, 7)

#     # Escalar igual que durante entrenamiento
...
# for i in range(3):
#     print(infer_crop(
#         [6,19,"Female","Undergraduate","Australia",7.2,"Instagram","Yes",4.5,4,"Complicated",5],
#         models[i],
#         scaler,
#         label_encoder
#     ))
...
#     input_df_features = input_df.drop('Escore', axis=1)

#     input_encoded = pd.get_dummies(input_df_features, columns=categorical_cols, drop_first=True)
...
#     # Predecir
#     prediction = model.eval(input_scaled)
#     # Decodificar etiqueta si es necesario
#     return label_encoder.inverse_transform(prediction)

def infer_crop(input_vector, model, scaler, label_encoder):
    # Crear un DataFrame con las mismas columnas originales
    input_df = pd.DataFrame([input_vector], columns=[
        'Student_ID',
        'Age',
        'Gender',
    ...
    # Reindex para añadir columnas faltantes sin fragmentar el DataFrame
